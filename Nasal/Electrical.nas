...
init_switches = func() {
  ...
  setprop("controls/lighting/mfi-norm",0.8);
  setprop("controls/lighting/panel-norm",0.8);
  setprop("systems/electrical/outputs/autopilot",20);
...
electrical_bus = func(bv) {
  ...
  var DIMMER = bus_volts * getprop("controls/lighting/instruments-norm");
  var INSTR_SWTCH = getprop("controls/lighting/instruments-norm");
  DIMMER=DIMMER*INSTR_SWTCH;

  setprop(outPut~"instrument-norm",DIMMER * 0.0357);
